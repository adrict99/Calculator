...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button buttonRaise = findViewById(R.id.btnElev);
        final Button buttonSquareRoot = findViewById(R.id.btnPosNeg);
        ...
        final TextView historyOne = findViewById(R.id.historyOne);
        final TextView historyTwo = findViewById(R.id.historyTwo);
        ...
        buttonPlus.setOnClickListener(v -> {
            mFirst = Float.parseFloat(operationNumbers.getText() + "");
            operation = "Plus";
        ...
        buttonEqual.setOnClickListener(v -> {
                switch (operation){
                    ...
                    case "SquareR" :
                        ...
                        historyOne.setText(mFirst + " " + "ⁿ√ₓ" + " " + mSecond + " = " + resultSquareR);
                        break;
                }
        });
    }
